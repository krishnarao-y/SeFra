...
public class HTMLReporter extends TestListenerAdapter implements IReporter {
    ...
    private void startHtmlPage(PrintWriter out)
    {
        ...
        out.println("<head>");
        out.println("<title>Krishna Test Results Summary</title>");
        out.println("</head>");
        out.println("<body><div style=\"margin:0 auto; padding:15px; min-height:450px; min-width: 450px; height:auto;\">"
                ...
                + "<h1 style=\"background-color: #93b874; color: white; text-align: center; font-family: Georgia;\">Krishna Automation Report</h1>");
    ...
    {
        out.println("<br/><br/><div align=\"right\"> &copy; <a href=\"http://www.Krishnatechnologies.com\">2017 Krishna Technologies.</a></div>");
